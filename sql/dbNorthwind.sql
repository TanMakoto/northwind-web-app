-- ==========================================================
-- Northwind Database from dbNorthwind (2).sql
-- Adapted for TiDB Cloud, MySQL 5.7+, MySQL 8.0+, Railway & Render
-- ==========================================================
...
CREATE TABLE `tb_suppliers` (
  ...
  `c_SupplierName` varchar(50) NOT NULL,
...
(12, 'Plutzer Lebensmittelgroßmärkte', 'Martin Bein', 'Bogenallee 51', 'Frankfurt', '60439', 'Germany', '(069) 992755'),
...
CREATE TABLE `tb_products` (
  ...
  `i_SupplierID` int(11) DEFAULT NULL,
  `i_CategoryID` int(11) DEFAULT NULL,
  `c_Unit` varchar(50) DEFAULT NULL,
  `i_Price` float NOT NULL DEFAULT 0.00
);
...
(73, 'Rød Kaviar', 17, 8, '24 - 150 g jars', 15),
(74, 'Longlife Tofu', 4, 7, '5 kg pkg.', 10),
(75, 'Rhönbräu Klosterbier', 12, 1, '24 - 0.5 l bottles', 7.75),
(76, 'Lakkalikööri', 23, 1, '500 ml', 18),
(77, 'Original Frankfurter grüne Soß', 12, 2, '12 boxes', 13);
